...
private:
    static struct Vector {
        ...
        Vector opBinary(string op:"*")(double s) const { return Vector(x * s, y * s, z * s); }
        Vector opBinary(string op:"+")(const Vector other) const { return Vector(x + other.x, y + other.y, z + other.z); }
        Vector opBinary(string op:"-")(const Vector other) const { return Vector(x - other.x, y - other.y, z - other.z); }
        ...
        Vector normalize() const { 
            ...
            if (mag == 0.0) return Vector(0, 0, 0);
            return this * (1.0 / mag); 
        }
    }
    ...
    static struct Color {
        ...
        Color opBinary(string op:"*")(double s) const { return Color(r * s, g * s, b * s); }
        Color opBinary(string op:"+")(const Color other) const { return Color(r + other.r, g + other.g, b + other.b); }
    }
...
protected:
    ...
    override string className() const { return "TextRaytracer"; }
