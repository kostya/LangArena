...
private:
    ...
    Tuple!(Tuple!(int, int)[], int) findPath() {
        ...
        gScores_[startIdx] = 0;
        openSet.insert(Node(startX_, startY_, 
                           heuristic(startX_, startY_, goalX_, goalY_)));
...
public:
    ...
    override string className() const { return "AStarPathfinder"; }    
