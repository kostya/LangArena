...
protected:
    ...
    int getNumThreads() const { return 4; }
...
protected:
    override string className() const { return "Matmul4T"; }
...
protected:
    override string className() const { return "Matmul8T"; }
    override int getNumThreads() const { return 8; }
}

class Matmul16T : Matmul4T {
protected:
    override string className() const { return "Matmul16T"; }
    override int getNumThreads() const { return 16; }
}