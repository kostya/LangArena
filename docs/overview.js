...
<div class="langclash-overview">
  ...
  <div class="intro">
    <strong>LangArena</strong> is a collection of <span class="highlight">40 diverse benchmarks</span> designed for a <span class="highlight">realistic, apples-to-apples comparison</span> of programming language performance. The goal is not to find the ultimate winner in micro-optimizations, but to evaluate how well each language's compiler or runtime optimizes clean, idiomatic, production-style code.
  </div>
  
  <div class="section">
    <h2 class="section-title">🔧 Origin & Methodology</h2>
    <p>The suite was initially authored in <strong>Crystal</strong> and then translated to other languages using AI-assisted tools (DeepSeek). This approach ensures functional and algorithmic parity, though the resulting code may not always be the absolute fastest version a language expert could write.</p>
