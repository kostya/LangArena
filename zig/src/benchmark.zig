...
pub const all_benchmarks_list = blk: {
    const list = &[_]BenchInfo{
        ...
        createBenchInfo("Matmul::T1", @import("matmul1t.zig").Matmul1T),
        createBenchInfo("Matmul::T4", @import("matmul4t.zig").Matmul4T),
        createBenchInfo("Matmul::T8", @import("matmul8t.zig").Matmul8T),
        createBenchInfo("Matmul::T16", @import("matmul16t.zig").Matmul16T),
