public class BrainfuckArray : Benchmark
{
    ...
    private class Tape
    {
        ...
        public void Inc() => _tape[_pos] = (byte)(_tape[_pos] + 1); // Wrapping overflow
        
        public void Dec() => _tape[_pos] = (byte)(_tape[_pos] - 1); // Wrapping overflow
    ...
    private class Program
    {
        ...
        private int[] _jumps; // Массив вместо Dictionary
